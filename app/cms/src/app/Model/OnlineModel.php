...
class OnlineModel extends NotORM
{
    ...
    public function getHomeLevelAll($level, $page, $perpage)
    {
        ...
        return $this->getORM()
            ->select('vod_id,vod_play_from,type_id,vod_name,vod_actor,vod_pic,vod_pic_slide,vod_remarks,vod_area,vod_lang,vod_year,vod_score,vod_time,vod_time_add,vod_content,vod_play_url')

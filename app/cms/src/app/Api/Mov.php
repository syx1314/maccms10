...
class Mov extends Api
{
    ...
    public function getAdConfig()
    {
        $ad = array(
            "ad_splash" => array(
                "img"=>"http://hanpeng.site/banner/kaiping.jpg",
                "link"=>""  //开屏广告
            ),
            "ad_home_1" => array(
                "img"=>"http://hanpeng.site/banner/tuijian1.jpg",
                "link"=>"" //推荐页广告
            ),
            "ad_home_2" => array(
                "img"=>"http://hanpeng.site/banner/tuijian1.jpg",
            ...
            "ad_home_3" => array(
                "img"=>"http://hanpeng.site/banner/tuijian2.jpg",
                "link"=>"" //推荐页广告
            ),
            "ad_home_4" => array(
                "img"=>"http://hanpeng.site/banner/tuijian1.jpg",
            ...
            "ad_player" => array(
                "img"=>"http://hanpeng.site/banner/playerbg.jpg",
                "link"=>"" //播放器广告
            ),
            "ad_user_center" => array(
                "img"=>"http://hanpeng.site/banner/gerenzhongxin.jpg",
                "link"=>"" //个人中心广告
            )
        );
        return $ad;
